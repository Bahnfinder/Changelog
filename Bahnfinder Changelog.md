...
- Die Deutsche Bahn hat vor einigen Tagen ohne Ankündigung ihre API abgeschaltet. Das bedeutet, dass das DB-Verkehrsnetz vorübergehend nicht verfügbar ist. Ich arbeite mit Hochdruck an einer Lösung. Du kannst dich benachrichtigen lassen, sobald es wieder funktioniert.
- 
- - Dieses Update enthält zusätzliche Informationen über den Ausfall des DB-Verkehrsnetzes.
...
- Die neuen Verkehrsnetz-Einstellungen zeigen dir jetzt empfohlene Netze sowie alle weiteren, nach Ländern sortiert.
- Neues App Icon: „Holz“
...
- - 3D-Touch Menü für Haltestellen: Zugriff auf zusätzliche Optionen für Haltestellen im Fahrtverlauf mit einem neuen 3D-Touch-Menü.
...
- - Split Screen: Nutze Bahnfinder jetzt im Split-Screen-Modus für noch effizienteres Multitasking.
- 
- Weitere Neuerungen: 
- 
...
- 
- - Neues Weihnachts-App Icon hinzugefügt.
...
- Neue Experimente-Option: Energiesparende Standortermittlung
- Allgemeine Verbesserungen 
...
- Neue App Icons: Rosa, Grau, Beta, Gespiegelt, Ozean, Sommer, Insta, Schwarzes Leder, Beiges Leder, Silbernes Metall, Schwarzes Metall, Spotlight, Busfinder, U-Bahnfinder, Ring, Gefüllter Ring.
...
- Ein Fehler wurde behoben, durch den in manchen Fällen keine Haltestelle beim App-Start gefunden wurde.
- Allgemeine Verbesserungen
